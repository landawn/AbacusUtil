...
public final class MutableShort extends Number implements Comparable<MutableShort>, Mutable {
     ...
     */
    public MutableShort setValue(final short value) {
        this.value = value;
     ...
     * @return
     */
    public boolean setIf(short newValue, ShortPredicate predicate) {
     ...
     * @return
     */
    public boolean setIf(short newValue, ShortBiPredicate predicate) {
