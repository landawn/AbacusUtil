...
final class ParallelArrayLongStream extends ArrayLongStream {
    ...
    public Stream<LongList> splitToList(final int size) {
        return new ParallelIteratorStream<LongList>(sequential().splitToList(size).iterator(), closeHandlers, false, null, maxThreadNum, splitor);
    }
    ...
    public <U> Stream<LongList> splitToList(final U identity, final BiFunction<? super Long, ? super U, Boolean> predicate,
            final Consumer<? super U> identityUpdate) {
        return new ParallelIteratorStream<LongList>(sequential().splitToList(identity, predicate, identityUpdate).iterator(), closeHandlers, false, null,
                maxThreadNum, splitor);
    }
    ...
    public Stream<LongList> slidingToList(final int windowSize, final int increment) {
        return new ParallelIteratorStream<LongList>(sequential().slidingToList(windowSize, increment).iterator(), closeHandlers, false, null, maxThreadNum, splitor);
    }
    ...
    public LongStream top(int n, Comparator<? super Long> comparator) {
        ...
        if (n >= toIndex - fromIndex) {
            ...
            return new ParallelArrayLongStream(elements, toIndex - n, toIndex, closeHandlers, sorted, maxThreadNum, splitor);
        } else {
            final long[] a = N.top(elements, fromIndex, toIndex, n, comparator);
            return new ParallelArrayLongStream(a, 0, a.length, closeHandlers, sorted, maxThreadNum, splitor);
        }
    }
    ...
    public LongStream sorted() {
        ...
        N.parallelSort(a);
        return new ParallelArrayLongStream(a, 0, a.length, closeHandlers, true, maxThreadNum, splitor);
    }
    ...
    public LongStream limit(long maxSize) {
        ...
        return new ParallelArrayLongStream(elements, fromIndex, (int) (fromIndex + maxSize), closeHandlers, sorted, maxThreadNum, splitor);
    ...
    public LongStream skip(long n) {
        ...
        if (n >= toIndex - fromIndex) {
            return new ParallelArrayLongStream(elements, toIndex, toIndex, closeHandlers, sorted, maxThreadNum, splitor);
        } else {
            return new ParallelArrayLongStream(elements, (int) (fromIndex + n), toIndex, closeHandlers, sorted, maxThreadNum, splitor);
        }
    }
    ...
    @Override
    public <K, U, V extends Collection<U>> Multimap<K, U, V> toMultimap(final LongFunction<? extends K> keyExtractor, final LongFunction<? extends U> valueMapper,
    ...
    public LongStream tail() {
        ...
        return new ParallelArrayLongStream(elements, fromIndex + 1, toIndex, closeHandlers, sorted, maxThreadNum, splitor);
    }
    ...
    public LongStream reversed() {
        return new ParallelIteratorLongStream(sequential().reversed().exIterator(), closeHandlers, false, maxThreadNum, splitor);
    }
    ...
    public OptionalLong findFirst(final LongPredicate predicate) {
        ...
        final List<CompletableFuture<Void>> futureList = new ArrayList<>(maxThreadNum);
        final Output<Throwable> eHolder = new Output<>();
        final Output<Pair<Integer, Long>> resultHolder = new Output<>();
    ...
    public LongStream onClose(Runnable closeHandler) {
        ...
        return new ParallelArrayLongStream(elements, fromIndex, toIndex, newCloseHandlers, sorted, maxThreadNum, splitor);
    }
}
