...
public final class IntList extends PrimitiveNumberList<IntConsumer, IntPredicate, Integer, int[], IntList> {
    ...
    public <R> List<R> flatMap3(final IntFunction<? extends Collection<? extends R>> func) {
        return flatMap3(0, size(), func);
    }

    public <R> List<R> flatMap3(final int fromIndex, final int toIndex, final IntFunction<? extends Collection<? extends R>> func) {
        return flatMap3(List.class, fromIndex, toIndex, func);
    }

    @SuppressWarnings("rawtypes")
    public <R, V extends Collection<R>> V flatMap3(final Class<? extends Collection> collClass, final IntFunction<? extends Collection<? extends R>> func) {
