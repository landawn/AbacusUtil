...
public final class BooleanList extends PrimitiveList<Boolean, boolean[], BooleanList> {
    ...
    public <K, V, M extends Map<K, V>, E extends Exception, E2 extends Exception> M toMap(Try.BooleanFunction<? extends K, E> keyMapper,
            Try.BooleanFunction<? extends V, E2> valueMapper, IntFunction<M> mapFactory) throws E, E2 {
    ...
    public <K, V, M extends Map<K, V>, E extends Exception, E2 extends Exception, E3 extends Exception> M toMap(
            Try.BooleanFunction<? extends K, E> keyMapper, Try.BooleanFunction<? extends V, E2> valueMapper, Try.BinaryOperator<V, E3> mergeFunction,
    ...
    public <K, A, D, M extends Map<K, D>, E extends Exception> M toMap(final Try.BooleanFunction<? extends K, E> keyMapper,
            final Collector<Boolean, A, D> downstream, final IntFunction<M> mapFactory) throws E {
        final M result = mapFactory.apply(size);
